...
import { Register_Patient, Country, State, City } from '../../../Lab_Apis/Lab_Patients/index';
...
const Add_Lab_Patinet = ({ show, handleclose }) => {
                                    ...
                                    <div>
                                        ...
                                        <FormControl variant="outlined" size='small' className={classes.formControl}  >
                                            <Select
                                                ...
                                                style={{ marginLeft: 10, marginTop: -10, fontWeight: 500 }}
                                            >
...
export default Add_Lab_Patinet
