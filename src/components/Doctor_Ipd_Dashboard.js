    ...
    return (
        <div className={classes.root} style={{ backgroundColor: '#ffffff' }}>
            ...
            >
                ...
                <Grid item className={classes.griditem} xs={12} sm={3} style={{ borderRight: '1px solid gray',marginTop:'1px',height:'90px' }}>
                    ...
                    <div className="row" style={{ padding: theme.spacing(0), color: '#00318B',marginLeft:'-4px' }}>
                        {
                            <Typography variant="h5" noWrap={true} style={{ marginLeft: 15 }}>
                                {(appointments.DailyAppointment !== null || appointments.DailyAppointment != 0) ? appointments.DailyAppointment : 0}
                            </Typography>
                ...
                <Grid item className={classes.griditem} xs={12} sm={3} style={{ borderRight: '1px solid gray' }}>
                    <Paper className={classes.paper} elevation={0} >
                        ...
                        <div className="row" style={{ padding: theme.spacing(0), color: '#00318B',marginLeft:'5px' }}>
                            <Typography variant="h5" noWrap={true}>
                                {(appointments.PatientInQueueAppointments !== null || appointments.PatientInQueueAppointments != 0) ? (appointments.PatientInQueueAppointments) : (0)}
                            </Typography>
                        </div>
