...
import { EditTips } from '../../../Admin_Apis/Tips';

const drawerWidth = 240;

const Edit_Tips = ({ show, data, handleclose }) => {
    ...
    const [description, setdescription] = useState(data.Discription ? data.Discription : '');
    const [category, setcategory] = useState(data.Category ? data.Category : '');
  
    const api_edit_tips = async () => {
        ...
        try {
            const edit_tips = await EditTips(obj);
            let parse = JSON.parse(edit_tips);
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                        ...
                        <Grid container>
                            ...
                            <Grid xs={12} sm={6}>
                                <Button className={classes.btnregister} onClick={api_edit_tips} style={{ float: 'left', marginLeft: 20 }}>
                                    Edit
                                </Button>
                            </Grid>
                        </Grid>
