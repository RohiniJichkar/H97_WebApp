...
import { DeleteClinics } from '../../../Admin_Apis/Clinic_Details';

const drawerWidth = 240;

const Delete_Clinics = ({ show, data, handleclose }) => {
    ...
    const handleDelete = async (clinicid) => {
        ...
        try {
            const delete_request = await DeleteClinics(clinicid);
    ...
    return (
        <>
            ...
            >
                <DialogTitle id="alert-dialog-title" style={{ fontFamily: 'Poppins', fontWeight: 600, fontSize: 20, color: '#2C7FB2' }}>{"Delete Clinic"}
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-slide-description" style={{ fontFamily: 'Poppins', fontWeight: 400, color: '#707070' }}>
                        Do you want to Delete Clinic Details?
                    </DialogContentText>
                </DialogContent>
                <DialogActions style={{ marginTop: 20 }}>
                    ...
                    <Button className={classes.btnregister} onClick={() => handleDelete(data.ClinicId)} style={{ width: 100 }}>
                        Yes
                    </Button>
                </DialogActions>
            </Dialog>
