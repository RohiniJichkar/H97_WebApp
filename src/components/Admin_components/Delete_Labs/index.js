...
import { Dialog, DialogContent, DialogContentText, DialogActions, DialogTitle, Slide, Select, FormControl, Button, IconButton, Grid, Paper, Link } from "@material-ui/core";
import CloseIcon from '@material-ui/icons/Close';
import { Delete_Labs_Details_by_id } from '../../../Admin_Apis/Labs';

const Transition = React.forwardRef(function Transition(props, ref) {
    return <Slide direction="up" ref={ref} {...props} />;
});

const Delete_Labs = ({ show, data, handleclose }) => {

    const classes = useStyles();

    const Delete_Api = async (UserId) => {
        console.log(UserId)
        const request = await Delete_Labs_Details_by_id(UserId);
