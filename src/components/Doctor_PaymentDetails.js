            ...
            <Paper elevation={6} className={classes.paper}>
              <Grid container>
                ...
                <Grid item xs={12} container style={{ borderBottom: '1px solid lightgray' }}  >
                  ...
                  <Grid item xs={12} sm={6}>
                    <center>
                      <TextField style={{ width: 150, marginBottom: 10, borderRadius: 25, }}
                        InputProps={{
                          inputProps: { min: 0 }
                        }}
                        onChange={(e) => setcostcode(e.target.value)} type='number' id="outlined-basic" size="small" label="Cost Code" variant="outlined" />
                    </center>
                  </Grid>
                </Grid>
                  ...
                  <Grid item xs={12} sm={6}>
                    <center>
                      <TextField className={classes.inputFields}
                        InputProps={{
                          inputProps: { min: 0 }
                        }} onChange={(e) => setfees(e.target.value)} type='number' id="outlined-basic" size="small" label="Fees" variant="outlined" />
                    </center>
                  </Grid>
                </Grid>
