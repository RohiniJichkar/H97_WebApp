...
export default function Doctor_IPD_Beds() {
    ...
    const fetchStaffData = async () => {
        ...
        const staffInfo = await axios.post( { ClinicId: clinicid });
    ...
    const searchStaff = async (staffsearch) => {
        ...
        let clinicid = parsed.ClinicId;
        try {
            const staffInfo = await axios.post( { ClinicId: clinicid, Name: staffsearch });
            ...
            >
                <Grid item xs={12}>
                    <Typography variant="h5" noWrap={true}
                        ...
                        Beds
                        <Button className={classes.btnregister} onClick={() => setOpenmodal(true)} style={{ float: 'right', marginRight: 20, width: '200px', fontFamily: 'Poppins', fontSize: 12.5, fontWeight: 400 }}>General Ward</Button>
                        <Button className={classes.btnregister} onClick={() => setOpenmodal(true)} style={{ float: 'right', marginRight: 20, width: '200px', fontFamily: 'Poppins', fontSize: 12.5, fontWeight: 400 }}>ICU Ward</Button>
                        <Button className={classes.btnregister} onClick={() => setOpenmodal(true)} style={{ float: 'right', marginRight: 20, width: '200px', fontFamily: 'Poppins', fontSize: 12.5, fontWeight: 400 }}>Labour Ward </Button>
                    </Typography>
                </Grid>
