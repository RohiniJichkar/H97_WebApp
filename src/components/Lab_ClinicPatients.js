...
import { Avatar, Slide, Typography, Button, InputBase, Divider, ListItem, ListItemText, Box, Grid, Paper } from "@material-ui/core";
...
import Edit_Lab_Patient from './Labs/Edit_Patient/index';
import Delete_Lab_Patient from './Labs/Delete_Patient/index';
import Add_Lab_Patinet from './Labs/Add_Patient/index';
...
export default function LabClinicPatients() {
    ...
    return (
        <div className={classes.root} style={{ backgroundColor: '#ffffff' }}>
            ...
            >
                ...
                {openmodal ? <Add_Lab_Patinet show={openmodal} handleclose={() => setOpenmodal(false)} /> : null}


                {openeditmodal ? <Edit_Lab_Patient show={openeditmodal} data={patientDetails} handleCloseEditmodal={() => setOpenEditmodal(false)} /> : null}


                {/* for Delete User */}

                {opendeletemodal ? <Delete_Lab_Patient show={opendeletemodal} data={patientDetails} handleclose={() => setOpenDeletemodal(false)} /> : null}
