...
export default function Doctor_IPD_Navbar() {
  ...
  const menuItems = [
    {
      text: 'Home',
      icon: HomeIcon,
      onClick: () => navigate("/DoctorIPDHome"),
    },
    {
      text: 'Dashboard',
      icon: DashboardIcon,
      onClick: () => navigate("/Doctor_Ipd_Dashboard"),
    },
    {
    ...
    },
    {
      ...
      icon:  HotelIcon,
      onClick: () => navigate("/Doctor_IPD_Beds"),
    },
    {
    ...
    },
    {
      text: "Upload Reports",
      icon: MedicationIcon,
      onClick: () => navigate("/Doctor_IPD_Medicines"),
    },
    // {
    //   text: 'Clinic Staff',
