...
export default function Edit_staff({ show, data, handleCloseEditmodal }) {
    ...
    const [edittitle, setedittitle] = useState(parse[0].NmTitle);
                                ...
                                <center>
                                    <div>
                                        <Grid container style={{ marginBottom: -10 }}>
                                                ...
                                                <center>
                                                    <FormControl variant="outlined" size='small' className={classes.formControl}  >
                                                        <Select
                                                            ...
                                                            style={{ marginLeft: 68, width: 78, marginTop: -8, fontWeight: 500 }}
                                                        >
                                            ...
                                            <Grid item xs={8}>
                                                <center>
                                                    <TextField className={classes.inputFields} value={editfirstName} onChange={(e) => {
                                                        const re = /^[A-Za-z]+$/;
